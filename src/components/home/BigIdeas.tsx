...
export default function BigIdeas() {
  return (
    <div className="flex min-h-screen w-full items-center bg-yellow-50">
      <Container>
        <div className="my-16 flex w-full flex-col items-center gap-12 lg:flex-row">
          <div className="flex flex-col gap-4">
            <h2 className="font-header text-6xl font-black text-red-50 lg:text-8xl">
              Big Ideas Deserve
              <br />a Big Impact
            </h2>
            ...
            <p className="mt-8 text-sm lg:mt-12" id="1">
              1.{' '}
              <a href="https://siteefy.com/how-many-websites-are-there/" target="_blank" className="hover:text-red-50">
                Siteefy
              </a>
              . Accessed July 2025.
            </p>
